        ...
        <View style={styles.container}>
          ...
          >
            <View style = {styles.center}>
                ...
                source={require('../assets/error403.jpg')}
                />
                <View style={styles.text}>
                    <Text style={styles.normal}>Ai incercat sa accesezi pagina care nu este disponibila pentru tine. Pentru a nu supara mai tare personalul revino la pagina anterioara.</Text>
                </View>
                <View style={styles.containerButton}>
                    ...
                    >
                        <TouchableOpacity style={styles.confirm} onPress={navigateToStore}>
